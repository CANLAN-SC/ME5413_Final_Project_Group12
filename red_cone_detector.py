...
class RedConeDetector:
    def __init__(self):
        rospy.init_node('red_cone_detector', anonymous=True)
        ...
        self.point_pub = rospy.Publisher("/red_cone_position", PointStamped, queue_size=1)
    ...
    def process(self):
        ...
        # Project image center (u, v) into point cloud
        selected_points = []
